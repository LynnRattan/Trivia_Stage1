...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LevelCode).HasName("PK__Levels__BE500FE3787B006D");
        });

        modelBuilder.Entity<Player>(entity =>
        {
            entity.HasKey(e => e.PlayerMail).HasName("PK__Players__F50BE709B6BC5AE6");
        ...
        {
            entity.HasKey(e => e.QuestionId).HasName("PK__Question__6238D4B2B9009943");
        ...
        {
            entity.HasKey(e => e.StatusCode).HasName("PK__Status__AD4366F768E158E1");
        });

        modelBuilder.Entity<Subject>(entity =>
        {
            entity.HasKey(e => e.SubjectCode).HasName("PK__Subjects__97E46C96401B55F2");
        });
